...
This project was built to demonstrate frontend development skills in designing and implementing an e-commerce interface.  
It emphasizes **user interface structure, component layout, and interactive elements** rather than backend or payment processing logic.

Key goals of this project:
- Simulate a real-world e-commerce landing page
...
- Responsive navigation bar with search input and authentication buttons
- Promotional banner carousel with auto-play
- New Arrival product section with horizontal slider
- Top Product product showcase
- Product cards with price, name, and action button
...
- Add dynamic product data using JSON or API
